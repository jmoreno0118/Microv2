...
<div>
  <div id="confirma">
    <h3>Confirmación de borrado del representante</h3>
    <form action="" method="post">
      <h4>Estas seguro de que deseas borrar al cliente número <?php htmlout($id); ?>, 
      con razon social <?php htmlout($razonsocial); ?>, ubicada en el estado de
      <?php htmlout($estado);?> con R.F.C. <?php htmlout($rfc);?>.</h4>
      <p>
