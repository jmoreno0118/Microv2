        ...
        <div style="display:block;overflow: hidden;">
          <?php if(isset($_SESSION['terminada']) OR isset($_SESSION['supervisada'])){ ?>
            <div style="float:right;">
              ...
              <a href="<?php htmlout('http://'.$_SERVER['HTTP_HOST'].'/reportes/nom003/pdf/index3.php?ot='.$nombreot['ot'].'&id='.$ot); ?>" target="_blank">Informe3</a>
            </div>
            <div style="float:right;">
              ...
              <a href="<?php htmlout('http://'.$_SERVER['HTTP_HOST'].'/reportes/nom003/pdf/index2.php?ot='.$nombreot['ot'].'&id='.$ot); ?>" target="_blank">Informe2</a>
            </div>
            <div style="float:right;">
              ...
              <a href="<?php htmlout('http://'.$_SERVER['HTTP_HOST'].'/reportes/nom003/pdf/index.php?ot='.$nombreot['ot'].'&id='.$ot); ?>" target="_blank">Informe</a>
            </div>
          <?php } ?>
