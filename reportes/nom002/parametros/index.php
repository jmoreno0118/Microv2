...
if (isset($_POST['accion']) and $_POST['accion']=='Siralab')
{
	...
	formularioSiralab('nom002', $_POST['muestreoid'], $valores, $mcompuesta, $_POST['cantidad'], 0);
}
    ...
    if($cantidad === 1){
			if($_POST['accion'] == 'volver' AND isset($_POST['coms'])){
					...
					$valores = array("empresagiro" => getEGiro($linea["ordenaguaidfk"]),
						           "descargaen" => $nom02maximos["descargaen"],
						           "uso" => $nom02maximos["uso"],
