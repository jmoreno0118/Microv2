...
if (isset($_POST['accion']) and $_POST['accion']=='borraplano')
{
	...
	$s->execute();
	$nombre=$s->fetch();
	$arch=$_SERVER['DOCUMENT_ROOT'].'/reportes/nom002/documentos/'.$nombre['nombrearchivado'];
...
if(isset($_POST['accion']) and $_POST['accion']=='subir')
{
	...
	$_SERVER['DOCUMENT_ROOT'].'/reportes/nom002/documentos/'.$nombrearchivar);
	if (!$semovio)
	{
	...
	chmod ($_SERVER['DOCUMENT_ROOT'].'/reportes/nom002/documentos/'.$nombrearchivar, 0777);
