      ...
      <div id="cuerpoprincipal"> 
        ...
        <div style="display:block;overflow: hidden;">
          ...
          <div style="float:right;">
              ...
              <a href="<?php htmlout('http://'.$_SERVER['HTTP_HOST'].'/reportes/nom001/pdf/index3.php?ot='.$nombreot['ot'].'&id='.$ot); ?>" target="_blank">Informe3</a>
            </div>
            <div style="float:right;">
          ...
          <?php foreach ($medsagua as $medagua): ?>
            <tr>
              ...
              <div>
                ...
                <?php if($medagua['tipomediciones'] !== '1' AND isset($_SESSION['supervisada']))
                { ?>
            ...
            <div style="height:150px;width:50%;overflow-y:auto;">
              <ul>
                <?php foreach ($comentarios as $value): ?>
                  <li><p><?php markdownout( $value['fecha'].': "'.$value['observacion'].'" - '.$value['supervisor']) ?></p></li>
                <?php endforeach; ?>
              </ul>
            </div>
          <?php
