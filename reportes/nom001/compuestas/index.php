...
if(isset($_POST['accion']) and $_POST['accion']=='guardar' OR isset($_POST['accion']) and $_POST['accion']=='siguiente')
{
	...
	{
		formularioParametros('nom001', $_POST['id'], $_POST['muestreoid'], intval($_POST['cantidad']), $_POST['idparametro'], json_decode($_POST['valores'],TRUE), json_decode($_POST['parametros'],TRUE), json_decode($_POST['adicionales'],TRUE), 1, $_POST['accionparam']);
	}else{
